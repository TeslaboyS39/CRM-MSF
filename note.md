...
-di laman pipeline
    ...
    [4]di menu add new customer masih ada yang kurang
        >kolom subscription period[[done]]
        >kolom segmentation[[done]]
            apabila terrain type dipilih off the road
                >>nickel
                >>coal
                >>plantation
            apabila terrain type dipilih on the road
                >>logistic
                >>passanger
